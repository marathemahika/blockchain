...
exports.register = async (req, res, next) => {
  try {
    ...
    // Register user on blockchain (async, non-blocking)
    blockchainService.registerUserOnChain(user._id.toString(), user.name).catch(err => {
      logger.warn(`Blockchain registration async error: ${err.message}`);
    });
